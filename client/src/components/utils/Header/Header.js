...
const Header = () => {
  ...
  return (
    <Fragment>
      <MobileHeader />
      {/* PC Header */}
      <div className="nav-bar hidden sm:block py-2">
          ...
          <div className="nav-bar__nav-search-cart grid grid-rows-2">
            <div className="nav-bar__nav-btns flex items-center justify-between">
              ...
              <ul className="flex gap-7 text-lg">
                ...
                <li className="hover:text-lime-500">
                  <a href="/create-product" className="font-semibold">
                    Create
                  </a>
                </li>
                <li className="hover:text-lime-500">
                ...
                <li className="text-sm flex items-center text-white hover:text-lime-500 hover:bg-white border-2 border-lime-500 bg-lime-500 px-4 rounded-full duration-150">
                  <a href="#" className="font-semibold">
                    Download App
                  </a>
                </li>
            ...
            <div className="nav-bar__search-cart">
              ...
              <div className="auth-btn flex justify-center w-32">
                <button onClick={openAuthModal} className="uppercase">
                  Login/Register
                </button>
              </div>
